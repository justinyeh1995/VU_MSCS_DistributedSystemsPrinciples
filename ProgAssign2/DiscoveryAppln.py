...
from CS6381_MW.DHTNodeMW import DHTNodeMW
...
class DiscoveryAppln ():
  ...
  def configure (self, args):
    ...
    try:
      ...
      self.mw_obj = DHTNodeMW (self.logger) # DiscoveryMW (self.logger)
      self.mw_obj.configure (args, config) # pass remainder of the args to the m/w object
