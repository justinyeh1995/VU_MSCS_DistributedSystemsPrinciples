h1 python3 DiscoveryAppln.py -P 5 -S 15 > discovery.out 2>&1 &
...
h17 python3 SubscriberAppln.py -d "10.0.0.1:5555" -T 5 -n sub11 > sub11.out 2>&1 &
h18 python3 SubscriberAppln.py -d "10.0.0.1:5555" -T 5 -n sub12 > sub12.out 2>&1 &
h19 python3 SubscriberAppln.py -d "10.0.0.1:5555" -T 5 -n sub13 > sub13.out 2>&1 &
h20 python3 SubscriberAppln.py -d "10.0.0.1:5555" -T 5 -n sub14 > sub14.out 2>&1 &
h21 python3 SubscriberAppln.py -d "10.0.0.1:5555" -T 5 -n sub15 > sub15.out 2>&1 &
