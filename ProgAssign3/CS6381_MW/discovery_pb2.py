...
_MSGTYPES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TYPE_DEREGISTER', index=5, number=5,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_REGISTRANTINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='RegistrantInfo.timestamp', index=3,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_timestamp', full_name='RegistrantInfo._timestamp',
...
_DEREGISTERREQ = _descriptor.Descriptor(
  name='DeregisterReq',
  full_name='DeregisterReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='role', full_name='DeregisterReq.role', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='info', full_name='DeregisterReq.info', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOOKUPPUBBYTOPICREQ = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='role', full_name='LookupPubByTopicReq.role', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='topiclist', full_name='LookupPubByTopicReq.topiclist', index=1,
...
_REGISTRANTINFO.oneofs_by_name['_timestamp'].fields.append(
  _REGISTRANTINFO.fields_by_name['timestamp'])
_REGISTRANTINFO.fields_by_name['timestamp'].containing_oneof = _REGISTRANTINFO.oneofs_by_name['_timestamp']
_REGISTERREQ.fields_by_name['role'].enum_type = _ROLE
_REGISTERREQ.fields_by_name['info'].message_type = _REGISTRANTINFO
_DEREGISTERREQ.fields_by_name['role'].enum_type = _ROLE
_DEREGISTERREQ.fields_by_name['info'].message_type = _REGISTRANTINFO
...
_LOOKUPPUBBYTOPICREQ.fields_by_name['role'].enum_type = _ROLE
...
DESCRIPTOR.message_types_by_name['DeregisterReq'] = _DEREGISTERREQ
...
DeregisterReq = _reflection.GeneratedProtocolMessageType('DeregisterReq', (_message.Message,), {
  'DESCRIPTOR' : _DEREGISTERREQ,
  '__module__' : 'discovery_pb2'
  # @@protoc_insertion_point(class_scope:DeregisterReq)
  })
_sym_db.RegisterMessage(DeregisterReq)
